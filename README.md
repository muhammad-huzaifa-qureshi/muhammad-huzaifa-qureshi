...
With a **strong foundation in programming logic and software engineering principles**, I actively work with Python and FastAPI to build modern, reliable backend systems. I design and integrate PostgreSQL and NoSQL databases, handle authentication, data storage, and real-time features, and **deploy applications** on cloud platforms like Google Cloud Run, ensuring **connected, efficient, and production-ready systems.**
...
### 🚀 Goals
I am driven by **consistent learning, building, and improving**, with the goal of growing as a **backend-focused software engineer**, contributing to **meaningful projects**, and creating systems that **make an impact**.
